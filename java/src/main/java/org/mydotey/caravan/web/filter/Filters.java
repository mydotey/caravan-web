...
public final class Filters {
    ...
    public static Filter newCompressingFilter(ServletContext context, String filterName,
    ...
    public static void registerCaseInsensitiveRequestParameterFilter(ServletContext context, String... urlPatterns) {
        registerFilter(context, DEFAULT_CASE_INSENSITIVE_REQUEST_PARAMETER_FILTER_NAME,
            newCaseInsensitiveRequestParameterFilter(), urlPatterns);
    }
    ...
    public static FilterRegistration.Dynamic registerFilter(ServletContext context, String filterName, Filter filter,
        ...
        ObjectExtension.requireNonNullOrEmpty(dispatcherTypes, "dispatcherTypes");
        ObjectExtension.requireNonNullOrEmpty(urlPatterns, "urlMapping");
